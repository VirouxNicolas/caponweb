...
<html lang="fr">
  ...
  <body>
        ...
        <a class="navbar-brand" href="./index">CAPON <span>WEB</span></a>
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item"><a href="./inc/connexion" class="nav-link">Connexion</a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
    ...
    <div class="hero-wrap" style="background-image: url('./images/accueil/site_CAP.jpg');" data-stellar-background-ratio="0.5">
      ...
      <div class="container">
        <div class="row no-gutters slider-text justify-content-start align-items-center">
          ...
          <div class="col-lg-4  mt-0 mt-md-5 d-flex">
          	<form action="#" class="request-form ftco-animate">
          		<h2>International contest 2019</h2>
	    				<div class="form-group">
	    					<label for="" class="label">Nom & prénom</label>
	    					<input type="text" class="form-control" placeholder="">
                        </div>
	    				<div class="form-group">
	    					<label for="" class="label">Nationalité</label>
                        ...
                        <div class="form-group">
	    					<label for="" class="label">FAI License</label>
	    					<input type="text" class="form-control" placeholder="">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
	    					<label for="" class="label">Banquet reservation</label>
	    					<input type="text" class="form-control" placeholder="">
                        </div>
                        <div class="form-group">
    ...
    <section class="ftco-section">
      <div class="container">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate mb-5">
            <h2 class="mb-2">Nos activités</h2>
          </div>
        </div>
            ...
            <div class="media block-6 services">
              <div class="media-body py-md-4">
              	<div class="d-flex mb-3 align-items-center">
	                ...
	                <h3 class="heading mb-0 pl-3">Lorem Ipsum</h3>
                </div>
            ...
            <div class="media block-6 services">
              <div class="media-body py-md-4">
              	<div class="d-flex mb-3 align-items-center">
	                ...
	                <h3 class="heading mb-0 pl-3">Lorem Ipsume</h3>
                </div>
                <p>A small river named Duden flows by their place and supplies it with you</p>
              </div>
            </div>      
    ...
    <section class="ftco-section services-section img" style="background-image: url(./images/accueil/site_CAP.jpg);">
    	<div class="overlay"></div>
    	<div class="container">
    		<div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center heading-section heading-section-white ftco-animate">
            <h2 class="mb-3">Challenge</h2>
          </div>
        </div>
    		<div class="row">
    			<div class="col-md-3 d-flex align-self-stretch ftco-animate">
      ...
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 heading-section text-center ftco-animate">
            <h2>Les prochaines activités du Centre d'Aeromodélisme de Pepinster</h2>
          </div>
        </div>
        <div class="row d-flex">
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
              <a href="#" class="block-20" style="background-image: url('./images/accueil/image1.jpg');">
              </a>
              <div class="text pt-4">
              	<div class="meta mb-3">
                  <div><a href="#">15 Septembre 2020</a></div>
                </div>
                <h3 class="heading mt-2"><a href="#">Lorem ipsum dolor sit amet, consectetur adipiscing elit</a></h3>
          ...
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
              <a href="blog-single.html" class="block-20" style="background-image: url('./images/accueil/image2.jpg');">
              </a>
              <div class="text pt-4">
              	<div class="meta mb-3">
                  <div><a href="#">14 Aout 2020</a></div>
                </div>
                <h3 class="heading mt-2"><a href="#">Lorem ipsum dolor sit amet, consectetur adipiscing elit</a></h3>
                <p>sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi..</p>
              </div>
          ...
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <a href="blog-single.html" class="block-20" style="background-image: url('./images/accueil/image3.jpg');">
              </a>
              <div class="text pt-4">
              	<div class="meta mb-3">
                  <div><a href="#">20 Juillet 2020</a></div> 
                </div>
                <h3 class="heading mt-2"><a href="#">Lorem ipsum dolor sit amet, consectetur adipiscing elit</a></h3>
